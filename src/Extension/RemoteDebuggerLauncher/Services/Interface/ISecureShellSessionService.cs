...
namespace RemoteDebuggerLauncher
{
   ...
   internal interface ISecureShellSessionService
   {
      ...
      /// <summary>
      /// Uploads the specified folder recursivly from the local PC to the remote host using SCP.
      /// </summary>
      ...
      /// <param name="progressLogger">The optinal logger to be used for logging progress.</param>
      /// <exception cref="SecureShellSessionException">thrown when the operation failed.</exception>
      Task UploadFolderRecursiveAsync(string localSourcePath, string remoteTargetPath, ILoggerService progressLogger = null);
      ...
      /// <param name="progressLogger">The optinal logger to be used for logging progress.</param>
      /// <exception cref="SecureShellSessionException">thrown when the operation failed.</exception>
      Task UploadFileAsync(string localSourcePath, string remoteTargetPath, ILoggerService progressLogger = null);
