...
namespace RemoteDebuggerLauncher.PowerShellHost
{
   ...
   /// </summary>
   /// <seealso cref="PSHost" />
   internal class PSHostCaptureOutput : PSHost
   {
      ...
      private readonly PSHostOutputCaptureUserInterface hostUserInterface = new PSHostOutputCaptureUserInterface();
      #endregion
      ...
      public override string Name => nameof(PSHostCaptureOutput);
